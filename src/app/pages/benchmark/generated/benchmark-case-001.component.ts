...
export class BenchmarkCase001Component {
  readonly pageTitle = 'Settings Remote Benchmark Case 001';
  readonly pageCode = 'SETTINGS-REMOTE-001';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Settings Remote case 001 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
