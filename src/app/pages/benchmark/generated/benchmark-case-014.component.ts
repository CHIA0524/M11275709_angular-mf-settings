...
export class BenchmarkCase014Component {
  readonly pageTitle = 'Settings Remote Benchmark Case 014';
  readonly pageCode = 'SETTINGS-REMOTE-014';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Settings Remote case 014 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
