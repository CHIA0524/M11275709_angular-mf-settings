...
export class BenchmarkCase013Component {
  readonly pageTitle = 'Settings Remote Benchmark Case 013';
  readonly pageCode = 'SETTINGS-REMOTE-013';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Settings Remote case 013 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
