...
export class BenchmarkCase004Component {
  readonly pageTitle = 'Settings Remote Benchmark Case 004';
  readonly pageCode = 'SETTINGS-REMOTE-004';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Settings Remote case 004 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
